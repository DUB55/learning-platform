                    ...
                    {isLoadingData ? (
                        ...
                        <div className="space-y-4">
                            {announcements.map((announcement) => (
                                <div
                                    key={announcement.id}
                                    className={`glass-card p-6 transition-all duration-300 ${getPriorityStyles(announcement.priority)} ${announcement.linked_page_id ? 'cursor-pointer hover:bg-white/5' : ''
                                        } ${!announcement.is_read ? 'bg-blue-500/5' : ''}`}
                                    onClick={() => announcement.linked_page_id && handleAnnouncementClick(announcement)}
                                >
