...
export default function ViewDocumentPage() {
    ...
    const fetchDocument = async () => {
        ...
        if (data) setDocument(data as unknown as Document);
        setLoading(false);
    };
    ...
    const hasHtmlContent = document?.elements?.some(e => e.type === 'html');
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex overflow-hidden">
            ...
            <main className={`flex-1 overflow-y-auto relative ${hasHtmlContent ? 'p-0' : 'p-8'}`}>
                    ...
                    <div className="flex items-center justify-between mb-6">
                        ...
                        {user?.id === document.user_id && (
                            <div className="flex gap-2">
                                <button
                                    onClick={() => router.push(`/subjects/${params.id}/units/${params.unitId}/paragraphs/${params.paragraphId}/documents/${documentId}/edit`)}
                ...
                {/* Document Content */}
                <div className={`space-y-6 ${hasHtmlContent ? '' : 'max-w-4xl mx-auto'}`}>
